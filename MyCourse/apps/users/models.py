...
# 在我們新建號項目和userapp之後進行數據庫的遷移生成之後就會自動生成一個django自帶的auth_user表裏面就有一些字段使我們需要的這裏我們爲了接着使用這些字段就繼承這個原有的AbstractUser就可以了
...
class EmailVerifyRecoed(models.Model):
    ...
    send_type = models.CharField(verbose_name=u"发送类型",choices=(("register",u"注册"),("forget",u"找回密码")),max_length=10)
